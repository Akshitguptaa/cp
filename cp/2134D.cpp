...
int bfs(int src, vi &par,vi &dist,vvi &adj){
    int n= adj.size()-1;
    ...
    int val = max_element(all(dist))-dist.begin();
...
void solve(){
    ...
    vi par, dist;
    int j = bfs(1,par,dist,adj);
    int k = bfs(j,par,dist,adj);
