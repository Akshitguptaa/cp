...
typedef tree<int, null_type, less<int>, rb_tree_tag,tree_order_statistics_node_update> ordered_set; // for m - eq // order_of_key(k) { <k } // *find_by_order(i) { 0-based }
